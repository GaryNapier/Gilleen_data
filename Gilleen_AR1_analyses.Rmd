...
```{r echo = FALSE, cache=F, htmlTable, results = 'asis'}
 ...
 Norm_table <-  cbind(Norm_omega2, Norm_omega3, Norm_nu, Norm_M2, Norm_M3, Norm_phi2, Norm_phi3)
  ...
  # kable(data.frame(Model_names, Norm_omega2, Norm_omega3, Norm_nu, Norm_M2, Norm_M3, Norm_phi2, Norm_phi3), padding = 0)
  
  Norm_tests <- data.frame(Model_names, SW_omega2, SW_omega3, SW_nu, SW_M2, SW_M3, SW_phi2, SW_phi3)
